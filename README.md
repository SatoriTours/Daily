...
[下载使用](https://github.com/SatoriTours/Daily/releases) · [问题反馈](https://github.com/SatoriTours/Daily/issues) · [讨论交流](https://github.com/SatoriTours/Daily/discussions)
...
- **本地优先**：数据默认保存在设备本地，先保证自己的内容自己可控。
- **少一点信息流，多一点沉淀**：不是让你刷更多，而是让内容更容易被整理、回看和复用。
- **AI 是整理助手，不是内容主人**：AI 用来提炼摘要、生成观点、辅助检索和陪你追问，但最终判断仍然属于你。
- **从日常入口开始**：文章、日记、读书、新闻和收藏都可以进入同一个系统，逐渐形成个人记忆。
...
- 记录文字、图片、心情和标签。
- 支持更轻量的日记卡片阅读与编辑体验。
- 可以生成周报，让一周的生活和想法被重新整理。
- 日记内容也可以成为 AI 助手回答时的本地记忆来源。

### 读书

- 添加书籍并生成核心观点卡片。
- 内置微信读书 Skill，可基于书籍资料提炼观点、案例和思考方向。
- 阅读页以单本书为中心，横向滑动阅读观点。
- 支持“想一想”：围绕当前观点继续追问、记录反思，并查看历史与已沉淀内容。

### 收藏同步

- 支持连接外部收藏来源，目前包含 X 收藏与 GitHub Stars。
- 可以定期同步收藏内容，把外部平台里的信息带回本地。
- GitHub Stars 会保存仓库简介、语言、主题和 README，再由 AI 整理并纳入本地搜索。
- 同步后的内容可以继续进入文章整理、AI 处理和本地检索流程。

### AI 助手

- 可以基于本地文章、日记、书籍观点等内容回答问题。
- 回答会带引用来源，方便回到原文、日记或读书观点继续查看。
...
Daily Satori 的目标不是做另一个“信息入口”，而是做一个长期陪伴的个人知识底座。
