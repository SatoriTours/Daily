...
class _DiaryCardState extends ConsumerState<DiaryCard> {
  ...
  String _truncateContent(String fullContent) {
    ...
    if (breakPos <= _maxCollapsedLength * 0.5) {
      ...
      if (breakPos <= _maxCollapsedLength * 0.5) {
        ...
        breakPos = spacePos > _maxCollapsedLength * 0.7
            ? spacePos
            : _maxCollapsedLength;
      }
    }
  ...
  bool get _hasTags =>
      widget.diary.tags != null && widget.diary.tags!.isNotEmpty;
  List<String> get _tagsList =>
      _hasTags ? widget.diary.tags!.split(',') : const [];
