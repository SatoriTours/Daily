...
/// 是否只显示收藏文章
 ...
 DateTime? get selectedFilterDate;/// 日历显示的月份
 DateTime? get calendarDisplayedMonth;/// 日历选中的日期
 DateTime? get calendarSelectedDate;/// 最后刷新时间
 DateTime? get lastRefreshTime;/// ScrollController (不在freezed中管理)
 ScrollController? get scrollController;/// TextEditingController (不在freezed中管理)
 TextEditingController? get searchController;/// FocusNode (不在freezed中管理)
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ArticlesControllerState&&(identical(other.onlyFavorite, onlyFavorite) || other.onlyFavorite == onlyFavorite)&&(identical(other.tagId, tagId) || other.tagId == tagId)&&(identical(other.tagName, tagName) || other.tagName == tagName)&&(identical(other.selectedFilterDate, selectedFilterDate) || other.selectedFilterDate == selectedFilterDate)&&(identical(other.calendarDisplayedMonth, calendarDisplayedMonth) || other.calendarDisplayedMonth == calendarDisplayedMonth)&&(identical(other.calendarSelectedDate, calendarSelectedDate) || other.calendarSelectedDate == calendarSelectedDate)&&(identical(other.lastRefreshTime, lastRefreshTime) || other.lastRefreshTime == lastRefreshTime)&&(identical(other.scrollController, scrollController) || other.scrollController == scrollController)&&(identical(other.searchController, searchController) || other.searchController == searchController)&&(identical(other.searchFocusNode, searchFocusNode) || other.searchFocusNode == searchFocusNode));
}


@override
int get hashCode => Object.hash(runtimeType,onlyFavorite,tagId,tagName,selectedFilterDate,calendarDisplayedMonth,calendarSelectedDate,lastRefreshTime,scrollController,searchController,searchFocusNode);

@override
String toString() {
  return 'ArticlesControllerState(onlyFavorite: $onlyFavorite, tagId: $tagId, tagName: $tagName, selectedFilterDate: $selectedFilterDate, calendarDisplayedMonth: $calendarDisplayedMonth, calendarSelectedDate: $calendarSelectedDate, lastRefreshTime: $lastRefreshTime, scrollController: $scrollController, searchController: $searchController, searchFocusNode: $searchFocusNode)';
}
...
@useResult
$Res call({
 bool onlyFavorite, int tagId, String tagName, DateTime? selectedFilterDate, DateTime? calendarDisplayedMonth, DateTime? calendarSelectedDate, DateTime? lastRefreshTime, ScrollController? scrollController, TextEditingController? searchController, FocusNode? searchFocusNode
});
...
/// Create a copy of ArticlesControllerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? onlyFavorite = null,Object? tagId = null,Object? tagName = null,Object? selectedFilterDate = freezed,Object? calendarDisplayedMonth = freezed,Object? calendarSelectedDate = freezed,Object? lastRefreshTime = freezed,Object? scrollController = freezed,Object? searchController = freezed,Object? searchFocusNode = freezed,}) {
...
as DateTime?,calendarDisplayedMonth: freezed == calendarDisplayedMonth ? _self.calendarDisplayedMonth : calendarDisplayedMonth // ignore: cast_nullable_to_non_nullable
as DateTime?,calendarSelectedDate: freezed == calendarSelectedDate ? _self.calendarSelectedDate : calendarSelectedDate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool onlyFavorite,  int tagId,  String tagName,  DateTime? selectedFilterDate,  DateTime? calendarDisplayedMonth,  DateTime? calendarSelectedDate,  DateTime? lastRefreshTime,  ScrollController? scrollController,  TextEditingController? searchController,  FocusNode? searchFocusNode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ArticlesControllerState() when $default != null:
return $default(_that.onlyFavorite,_that.tagId,_that.tagName,_that.selectedFilterDate,_that.calendarDisplayedMonth,_that.calendarSelectedDate,_that.lastRefreshTime,_that.scrollController,_that.searchController,_that.searchFocusNode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool onlyFavorite,  int tagId,  String tagName,  DateTime? selectedFilterDate,  DateTime? calendarDisplayedMonth,  DateTime? calendarSelectedDate,  DateTime? lastRefreshTime,  ScrollController? scrollController,  TextEditingController? searchController,  FocusNode? searchFocusNode)  $default,) {final _that = this;
switch (_that) {
case _ArticlesControllerState():
return $default(_that.onlyFavorite,_that.tagId,_that.tagName,_that.selectedFilterDate,_that.calendarDisplayedMonth,_that.calendarSelectedDate,_that.lastRefreshTime,_that.scrollController,_that.searchController,_that.searchFocusNode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool onlyFavorite,  int tagId,  String tagName,  DateTime? selectedFilterDate,  DateTime? calendarDisplayedMonth,  DateTime? calendarSelectedDate,  DateTime? lastRefreshTime,  ScrollController? scrollController,  TextEditingController? searchController,  FocusNode? searchFocusNode)?  $default,) {final _that = this;
switch (_that) {
case _ArticlesControllerState() when $default != null:
return $default(_that.onlyFavorite,_that.tagId,_that.tagName,_that.selectedFilterDate,_that.calendarDisplayedMonth,_that.calendarSelectedDate,_that.lastRefreshTime,_that.scrollController,_that.searchController,_that.searchFocusNode);case _:
  return null;
...
class _ArticlesControllerState extends ArticlesControllerState {
  const _ArticlesControllerState({this.onlyFavorite = false, this.tagId = -1, this.tagName = '', this.selectedFilterDate, this.calendarDisplayedMonth, this.calendarSelectedDate, this.lastRefreshTime, this.scrollController, this.searchController, this.searchFocusNode}): super._();
...
/// 日历显示的月份
@override final  DateTime? calendarDisplayedMonth;
/// 日历选中的日期
@override final  DateTime? calendarSelectedDate;
/// 最后刷新时间
...
/// Create a copy of ArticlesControllerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? onlyFavorite = null,Object? tagId = null,Object? tagName = null,Object? selectedFilterDate = freezed,Object? calendarDisplayedMonth = freezed,Object? calendarSelectedDate = freezed,Object? lastRefreshTime = freezed,Object? scrollController = freezed,Object? searchController = freezed,Object? searchFocusNode = freezed,}) {
