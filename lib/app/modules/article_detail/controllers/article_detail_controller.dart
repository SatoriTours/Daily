...
class ArticleDetailController extends BaseGetXController {
  ...
  Future<void> deleteArticle() async {
    ...
    await ArticleRepository.instance.deleteArticle(articleId);
    // 通知文章删除
  ...
  Future<void> generateMarkdownContent() async {
    ...
    await safeExecute(
      () async {
        ...
        await ArticleRepository.instance.updateModel(articleModel);
        // 刷新本地与列表视图
        article.refresh();
        // 通知全局状态服务文章已更新
