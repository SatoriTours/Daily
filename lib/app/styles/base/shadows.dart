...
class AppShadows {
  ...
  static List<BoxShadow> xsLight = [
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.extraLow), blurRadius: 1, offset: const Offset(0, 1)),
  ];

  /// 小阴影 - 用于UI元素的基本高度
  static List<BoxShadow> sLight = [
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.extraLow), blurRadius: 2, offset: const Offset(0, 1)),
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.low), blurRadius: 3, offset: const Offset(0, 1)),
  ];
  ...
  static List<BoxShadow> xlLight = [
    ...
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.mediumLow), blurRadius: 25, offset: const Offset(0, 15)),
  ];

  // 暗色模式阴影
  /// 极小阴影 - 用于微妙的高度表现（暗色模式）
  static List<BoxShadow> xsDark = [
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.mediumLow), blurRadius: 1, offset: const Offset(0, 1)),
  ];

  /// 小阴影 - 用于UI元素的基本高度（暗色模式）
  static List<BoxShadow> sDark = [
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.medium), blurRadius: 2, offset: const Offset(0, 1)),
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.mediumHigh), blurRadius: 3, offset: const Offset(0, 1)),
  ];

  /// 中等阴影 - 用于卡片、按钮等（暗色模式）
  static List<BoxShadow> mDark = [
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.mediumHigh), blurRadius: 6, offset: const Offset(0, 2)),
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.high), blurRadius: 4, offset: const Offset(0, 3)),
  ];

  /// 大阴影 - 用于弹出框、对话框等（暗色模式）
  static List<BoxShadow> lDark = [
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.high), blurRadius: 8, offset: const Offset(0, 4)),
  ...
  static List<BoxShadow> xlDark = [
    ...
    BoxShadow(color: Colors.black.withValues(alpha: Opacities.higher), blurRadius: 25, offset: const Offset(0, 15)),
  ];
