...
class AppShadows {
  ...
  static List<BoxShadow> xlLight = [
    ...
    BoxShadow(
      color: Colors.black.withValues(alpha: Opacities.mediumLow),
      blurRadius: 25,
  ...
  static List<BoxShadow> sDark = [
    ...
    BoxShadow(
      color: Colors.black.withValues(alpha: Opacities.mediumHigh),
      blurRadius: 3,
      offset: const Offset(0, 1),
    ),
  ];
  ...
  static List<BoxShadow> mDark = [
    ...
    BoxShadow(
      color: Colors.black.withValues(alpha: Opacities.high),
      blurRadius: 4,
      offset: const Offset(0, 3),
    ),
  ];
  ...
  static List<BoxShadow> xlDark = [
    ...
    BoxShadow(
      color: Colors.black.withValues(alpha: Opacities.higher),
      blurRadius: 25,
      offset: const Offset(0, 15),
    ),
  ];
