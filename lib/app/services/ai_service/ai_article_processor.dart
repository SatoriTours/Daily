...
class AiArticleProcessor {
  ...
  Future<void> _processTitle(ArticleModel article) async {
    ...
    try {
      ...
      ArticleRepository.d.updateField(articleId, ArticleFieldName.aiTitle, aiTitle);
  ...
  Future<void> _processSummary(ArticleModel article) async {
    ...
    try {
      ...
      ArticleRepository.d.updateField(articleId, ArticleFieldName.aiContent, summary);
  ...
  Future<void> _processMarkdown(ArticleModel article) async {
    ...
    try {
      ...
      ArticleRepository.d.updateField(articleId, ArticleFieldName.aiMarkdownContent, markdown);
  ...
  Future<void> _processImage(ArticleModel article) async {
    ...
    try {
      ...
      ArticleRepository.d.updateField(articleId, ArticleFieldName.coverImage, path);
